...
const Navigation = () => {
  ...
  return <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50 shadow-soft">
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-semibold text-foreground">Polisbuddy</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {user ? <Link to="/chat" className={`transition-colors text-sm font-medium ${location.pathname === '/chat' ? 'text-primary' : 'text-muted-foreground hover:text-primary'}`}>
                Chat
              </Link> : <button onClick={() => window.location.href = '/auth'} className="transition-colors text-sm font-medium text-muted-foreground hover:text-primary">
                Chat
              </button>}
          ...
          <div className="flex items-center space-x-3">
            {user ? <>
                ...
                <Button variant="ghost" onClick={handleSignOut} className="text-muted-foreground hover:text-foreground text-sm">
